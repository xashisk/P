 ...
 */
public class PrimitiveVSw<T> implements ValueSummary<PrimitiveVS<T>> {
    /**
    ...
    public PrimitiveDomainVS<T> toPrimitiveDomainVS() {
        return PrimitiveDomainVS.fromPrimitiveVS(this);
    }
